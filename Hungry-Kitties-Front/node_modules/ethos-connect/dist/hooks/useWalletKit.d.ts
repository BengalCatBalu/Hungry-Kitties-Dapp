...
declare const useWalletKit: ({ defaultChain, configuredAdapters, features, enableUnsafeBurner, preferredWallets, storageAdapter, storageKey, disableAutoConnect }: UseWalletKitArgs) => {
    ...
    signMessage(messageInput: Omit<import("@mysten/wallet-standard").SuiSignMessageInput, "account"> & Partial<Pick<import("@mysten/wallet-standard").SuiSignMessageInput, "account">>): Promise<import("@mysten/sui.js").SignedMessage>;
    signTransactionBlock: (transactionInput: Omit<import("@mysten/wallet-standard").SuiSignTransactionBlockInput, "account" | "chain"> & Partial<Pick<import("@mysten/wallet-standard").SuiSignTransactionBlockInput, "account" | "chain">>) => Promise<SignedTransaction>;
    signAndExecuteTransactionBlock: (transactionInput: Omit<import("@mysten/wallet-standard").SuiSignAndExecuteTransactionBlockInput, "account" | "chain"> & Partial<Pick<import("@mysten/wallet-standard").SuiSignAndExecuteTransactionBlockInput, "account" | "chain">>) => Promise<{
        digest: string;
    ...
    wallets: import("@mysten/wallet-adapter-base").WalletAdapter[];
