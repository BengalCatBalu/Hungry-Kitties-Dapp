...
var GasCostSummary2 = (0, import_superstruct10.object)({
  computationCost: (0, import_superstruct10.string)(),
  storageCost: (0, import_superstruct10.string)(),
  storageRebate: (0, import_superstruct10.string)(),
  nonRefundableStorageFee: (0, import_superstruct10.string)()
});
...
var ValidatorSignature = (0, import_superstruct10.string)();
var EndOfEpochData = (0, import_superstruct10.object)({
  nextEpochCommittee: (0, import_superstruct10.array)((0, import_superstruct10.tuple)([(0, import_superstruct10.string)(), (0, import_superstruct10.string)()])),
  nextEpochProtocolVersion: (0, import_superstruct10.string)(),
...
var NetworkMetrics = (0, import_superstruct19.object)({
  ...
  currentCheckpoint: (0, import_superstruct19.string)(),
  currentEpoch: (0, import_superstruct19.string)(),
  totalAddresses: (0, import_superstruct19.string)(),
  totalObjects: (0, import_superstruct19.string)(),
  totalPackages: (0, import_superstruct19.string)()
});

// src/types/epochs.ts
var import_superstruct20 = require("superstruct");
var EndOfEpochInfo = (0, import_superstruct20.object)({
  lastCheckpointId: (0, import_superstruct20.string)(),
  epochEndTimestamp: (0, import_superstruct20.string)(),
  protocolVersion: (0, import_superstruct20.string)(),
  referenceGasPrice: (0, import_superstruct20.string)(),
  totalStake: (0, import_superstruct20.string)(),
  storageFundReinvestment: (0, import_superstruct20.string)(),
  storageCharge: (0, import_superstruct20.string)(),
  storageRebate: (0, import_superstruct20.string)(),
  storageFundBalance: (0, import_superstruct20.string)(),
  stakeSubsidyAmount: (0, import_superstruct20.string)(),
  totalGasFees: (0, import_superstruct20.string)(),
  totalStakeRewardsDistributed: (0, import_superstruct20.string)(),
  leftoverStorageFundInflow: (0, import_superstruct20.string)()
});
var EpochInfo = (0, import_superstruct20.object)({
  epoch: (0, import_superstruct20.string)(),
  validators: (0, import_superstruct20.array)(SuiValidatorSummary),
  epochTotalTransactions: (0, import_superstruct20.string)(),
  firstCheckpointId: (0, import_superstruct20.string)(),
  epochStartTimestamp: (0, import_superstruct20.string)(),
...
var EpochPage = (0, import_superstruct20.object)({
  ...
  nextCursor: (0, import_superstruct20.nullable)((0, import_superstruct20.string)()),
