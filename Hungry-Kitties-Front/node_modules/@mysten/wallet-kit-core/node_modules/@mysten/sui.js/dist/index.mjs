...
var GasCostSummary2 = object10({
  computationCost: string10(),
  storageCost: string10(),
  storageRebate: string10(),
  nonRefundableStorageFee: string10()
});
...
var ValidatorSignature = string10();
var EndOfEpochData = object10({
  nextEpochCommittee: array8(tuple3([string10(), string10()])),
  nextEpochProtocolVersion: string10(),
...
var TransactionArgumentTypes = [
  ...
  object13({ kind: literal8("Result"), index: integer() }),
  object13({
...
var PublishTransaction = object13({
  ...
  modules: array10(array10(integer())),
...
var PureCallArg = object14({ Pure: array11(integer2()) });
...
import { number as number12, object as object16, string as string16 } from "superstruct";
var NetworkMetrics = object16({
  currentTps: number12(),
  tps30Days: number12(),
  currentCheckpoint: string16(),
  currentEpoch: string16(),
  totalAddresses: string16(),
  totalObjects: string16(),
  totalPackages: string16()
});

// src/types/epochs.ts
import { array as array13, boolean as boolean10, nullable as nullable11, object as object17, string as string17 } from "superstruct";
var EndOfEpochInfo = object17({
  lastCheckpointId: string17(),
  epochEndTimestamp: string17(),
  protocolVersion: string17(),
  referenceGasPrice: string17(),
  totalStake: string17(),
  storageFundReinvestment: string17(),
  storageCharge: string17(),
  storageRebate: string17(),
  storageFundBalance: string17(),
  stakeSubsidyAmount: string17(),
  totalGasFees: string17(),
  totalStakeRewardsDistributed: string17(),
  leftoverStorageFundInflow: string17()
});
var EpochInfo = object17({
  epoch: string17(),
  validators: array13(SuiValidatorSummary),
  epochTotalTransactions: string17(),
  firstCheckpointId: string17(),
  epochStartTimestamp: string17(),
  endOfEpochInfo: nullable11(EndOfEpochInfo)
});
var EpochPage = object17({
  data: array13(EpochInfo),
  nextCursor: nullable11(string17()),
